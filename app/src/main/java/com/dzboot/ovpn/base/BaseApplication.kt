...
//no need to extend OpenVPNApplication
abstract class BaseApplication<T : BaseActivity<*>>(
    ...
    override fun onCreate() {
        ...
        if (BuildConfig.DEBUG) {
            ...
            FirebaseMessaging.getInstance().subscribeToTopic("${packageName}-debug")
        } else {
            FirebaseMessaging.getInstance().subscribeToTopic("${packageName}-all")
        }
        ...
        NotificationsHelper.showPersistentNotification(this, clazz)
    }
